...

        {
            user?.email ?
                <>
                    ...
                    <li className='font-semibold'><Link to="/home">Advertise-Products</Link></li>
                </>
                :
    ...
    return (
        <div className="navbar  bg-clr mb-2 mt-3 rounded-lg ">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost normal-case text-3xl"><img className="logo-img" src={logo} alt="" srcset="" />Easy Buy & Sell</a>
